 ...
 */
static float grad(const int32_t hash, const float x) {
 ...
 * @return gradient value
 */
static float grad(const int32_t hash, const float x, const float y, const float z) {
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::noise(const float x, const float y, const float z) {
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::fractal(const size_t octaves, const float x) const {
    float output    = 0.f;
    float denom     = 0.f;
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::fractal(const size_t octaves, const float x, const float y) const {
    float output = 0.f;
    float denom  = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
 ...
 * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
 */
float SimplexNoise::fractal(const size_t octaves, const float x, const float y, const float z) const {
    float output = 0.f;
    float denom  = 0.f;
    float frequency = mFrequency;
    float amplitude = mAmplitude;
